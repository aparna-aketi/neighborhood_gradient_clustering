...
python trainer.py  --data-dir ../data   --lr=0.01  --batch-size=160  --world_size=5 --skew=1 --gamma=1 --normtype evonorm --optimizer d-psgd --epoch 100 --arch=cganet --momentum=0.0 --alpha 1.0
cd ./outputs
python dict_to_csv.py --norm evonorm --lr 0.01 --gamma 1 --arch cganet --world_size 5 --optimizer d-psgd --alpha 1.0 --skew 1 --graph ring
cd ..
