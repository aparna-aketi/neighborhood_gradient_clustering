...
if args.save_dir is None:
    if args.norm is not None:
        args.save_dir = args.optimizer+"_"+args.arch+"_nodes_"+str(args.world_size)+"_"+ args.norm+"_lr_"+ str(args.lr)+"_gamma_"+str(args.gamma)+"_alpha_"+str(args.alpha)+"_skew_"+str(args.skew)+"_"+args.graph
